    ...
    <>
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
        <PopoverTrigger asChild>
          <Button variant="ghost" size="icon" className="text-muted-foreground z-50 rounded-xl hover:bg-sidebar-accent hover:text-sidebar-accent-foreground -mt-0.5 size-7 relative border border-transparent hover:border-sidebar-border">
